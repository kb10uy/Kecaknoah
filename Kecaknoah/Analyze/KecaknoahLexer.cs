...
namespace Kecaknoah.Analyze
{
    ...
    public sealed class KecaknoahLexer
    {
        ...
        private static IOrderedEnumerable<Tuple<string, KecaknoahTokenType>> Operators = new List<Tuple<string, KecaknoahTokenType>>
        {
            ...
            new Tuple<string, KecaknoahTokenType>("++", KecaknoahTokenType.Increment),
            new Tuple<string, KecaknoahTokenType>("--", KecaknoahTokenType.Decrement),
            new Tuple<string, KecaknoahTokenType>("?", KecaknoahTokenType.Question),
            new Tuple<string, KecaknoahTokenType>(":", KecaknoahTokenType.Colon),
